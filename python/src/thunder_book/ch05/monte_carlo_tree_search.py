...
def mcts_vs_monte_carlo(num_playout: int = 30):
    ...
    num_games = 100
    win_rate = average_score(num_games=num_games, actions_wb=(mcts_action_f, monte_carlo_action_f))
...
def mcts_compare(a: int = 100, b: int = 10):
    ...
    num_games = 100
    win_rate = average_score(num_games=num_games, actions_wb=(mcts_action_a, mcts_action_b))
